...
class Auth extends MY_Controller
{
	...
	public function login()
	{
		...
		else
		{
			...
			$this->data['title'] = 'VBUW ' . lang('title_login');
	 ...
	 * Forgot password
	 * 
	 * @param $email : if user is created
	 */
	...
	/**
	 * The activation forgot password
	 * 
	 * @param email
	 */
	private function activate_forgot_password($email)
	{
		$identity_column = $this->config->item('identity', 'ion_auth');
	...
	public function create_user()
	{
		...
		if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data))
		{
			...
			// activeer een vergeten paswoord
			if($this->config->item('password_activation', 'ion_auth'))
			{
				$this->activate_forgot_password($email);
			}
			$this->session->set_flashdata('message', $this->ion_auth->messages());
			redirect("/", 'refresh');
		}
	...
	*/
	...
	public function _render_page($view, $data = NULL, $returnhtml = FALSE)//I think this makes more sense
	{
		...
		$title['title'] = (!empty($viewdata['title'])) ? $viewdata['title'] : 'Undefined';
