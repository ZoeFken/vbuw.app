...
<section class="d-flex justify-content-center">
  ...
  echo form_open('create_verdeler/verdeler', $attributes);
  echo validation_errors();
  ?>
  <div class="form-group">
    <div class="form-group col-md-13">
      <?php echo form_error('documentNaam'); ?>
      <label for="documentNaam"><?php echo $this->lang->line('documentNaam'); ?></label>
      <input type="text" name="documentNaam" class="form-control" id="documentNaam" placeholder="FBSS 10/0001">
    </div>
    <div class="form-group col-md-13">
      <?php echo form_error('bnx'); ?>
      <label for="bnx"><?php echo $this->lang->line('bnx'); ?></label>
      <input type="text" name="bnx" class="form-control" id="bnx" placeholder="43G-0000012-002">
    </div>
    <div class="form-group col-md-13">
      <?php echo form_error('tpo'); ?>
      <label for="tpo"><?php echo $this->lang->line('tpo'); ?></label>
      <input type="text" name="tpo" class="form-control" id="tpo" placeholder="TPO nr: I-AM-SP-2020-DNS-Addendum 2 of F.B.S.S nr 20/2020">
    </div>
    <div class="row">
      <div class="form-group col-md-6 col-xs-13">
        ...
        <input type="text" name="aanvangsDatum" id="aanvangsDatum" class="form-control date" placeholder="DD-MM-YYYY" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01])-(0[1-9]|1[012])-[0-9]{4}">
      </div>
      <div class="form-group col-md-6 col-xs-13">
        ...
        <input type="time" name="aanvangUur" class="form-control" id="aanvangUur">
      </div>
    </div>
    <div class="row">
      <div class="form-group col-md-6 col-xs-13">
      ...
      <div class="form-group col-md-6 col-xs-13">
        ...
        <input type="time" name="eindUur" class="form-control" id="eindUur">
      </div>
    </div>
    <div class="row">
      <div class="form-group col-md-6 col-xs-13">
        ...
        <input type="text" name="lijn" class="form-control" id="lijn" placeholder="75">
      </div>
      <div class="form-group col-md-6 col-xs-13">
        <?php echo form_error('spoor'); ?>
        <label for="spoor"><?php echo $this->lang->line('spoor'); ?></label>
        <input type="text" name="spoor" class="form-control" id="spoor" placeholder="A&B">
      </div>
    </div>
    <!-- <div class="row">
         <div class="form-group col-md-6 col-xs-13">
            ...
            ?>
           <label for="kpVan"><?php // echo $this->lang->line('kpVan'); 
                              ?></label>
           <input type="text" name="kpVan" class="form-control" id="kpVan" placeholder="12.010">
         </div>
         <div class="form-group col-md-6 col-xs-13">
				   <?php // echo form_error('kpTot'); 
            ?>
           <label for="kpTot"><?php // echo $this->lang->line('kpTot'); 
                              ?></label>
           <input type="text" name="kpTot" class="form-control" id="kpTot" placeholder="15.250">
         </div>
       </div> -->
    <div class="form-group col-md-13">
      <?php echo form_error('gevallen'); ?>
      <label for="gevallen"><?php echo $this->lang->line('gevallen'); ?></label>
      <input type="text" name="gevallen" class="form-control" id="gevallen" placeholder="29210, 29220, 292230">
    </div>
    <div class="form-group col-md-13">
      <?php echo form_error('uiterstePalen'); ?>
      <label for="uiterstePalen"><?php echo $this->lang->line('uiterstePalen'); ?></label>
      <input type="text" name="uiterstePalen" class="form-control" id="uiterstePalen" placeholder="Sp A: 13/20 & 15/15 en Sp B: 14/20 & 16/15">
    </div>
    <div class="form-group col-md-13">
      <?php echo form_error('geplaatstePalen'); ?>
      <label for="geplaatstePalen"><?php echo $this->lang->line('geplaatstePalen'); ?></label>
      <input type="text" name="geplaatstePalen" class="form-control" id="geplaatstePalen" placeholder="Sp A: 13/20 & 15/15 en Sp B: 14/20 & 16/15">
    </div>
  </div>
