...
<?php 
	...
	echo form_open('create_s505/s505', $attributes); 
?>
     <div class="form-group">
       <div class="row">
         <div class="form-group col-md-6 col-xs-13">
           <label for="houderS627"><?php echo $this->lang->line('houderS627'); ?></label>
           <input type="text" name="houderS627" class="form-control" id="houderS627" placeholder="John Doe" value="<?php echo set_value('houderS627'); ?>">
         </div>
         <div class="form-group col-md-6 col-xs-13">
           <label for="verantwoordelijkebss"><?php echo $this->lang->line('verantwoordelijkeBss'); ?></label>
           <input type="text" name="verantwoordelijkeBss" class="form-control" id="verantwoordelijkeBss" placeholder="Pieter-Jan Casteels" value="<?php echo set_value('verantwoordelijkeBss'); ?>">
         </div>
       </div>
       <div class="form-group col-md-13 col-xs-13">
           <label for="gevallen"><?php echo $this->lang->line('gevallen'); ?></label>
           <input type="text" name="gevallen" class="form-control" id="gevallen" placeholder="29450, 29451, 29452, ..." value="<?php echo set_value('gevallen'); ?>">
       </div>
       <div class="row">
       ...
       <div class="form-group col-md-13 col-xs-13">
           ...
           <input type="text" name="tpoBnx" class="form-control" id="tpoBnx" placeholder="TPO of BNX" value="<?php echo set_value('tpoBnx'); ?>">
       </div>
