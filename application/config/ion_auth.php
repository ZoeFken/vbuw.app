...
$config['password_activation']		  = TRUE;				 // Send email for password reset on activation
...
$config['message_start_delimiter'] = '<div class="p-3 mb-2 bg-warning text-white">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="p-3 mb-2 bg-danger text-white">';		// Error message start delimiter
